...
**NOTE:** If WPS is disabled on the target network, or if it's enabled, but configured to use push button or PBC, then I will have to hack WPA/WPA2 with a wordlist(Using Handshake).                      
