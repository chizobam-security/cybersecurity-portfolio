...
- Scanning:  scans the network for specific information based on information gathered during reconnaissance. Tools include: port scanners, network mappers, ping tools, and vulnerability scanners. Extract information such as live machines, port, port status, OS details, device type, and system uptime.
