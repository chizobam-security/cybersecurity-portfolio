...
### Screenshot
![Allow List](../screenshots/allow-list.png)

2. Then, I used a with statement to open the file:

![Open statement](../screenshots/open-statement.png)
...
![Read statement](../screenshots/read-statement.png)
